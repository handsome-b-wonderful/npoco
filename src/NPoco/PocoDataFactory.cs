...
namespace NPoco
{
    public class PocoDataFactory
    {
        ...
        // md: removed static modifer to clean up cache when database object disposed for new connection (Oracle table names have schema prepended vs. other providers)
        private readonly Cache<Type, PocoData> _pocoDatas = new Cache<Type, PocoData>();
